...
def generate_model():
    class DenseModel(nn.Module):
        def __init__(self, pretrained_model):
            ...
            self.classifier = nn.Linear(pretrained_model.classifier.in_features, DefaultConfig.num_classes)
...
def get_net():
    ...
    model.conv1 = nn.Conv2d(6, 64, kernel_size=3,
                               stride=1, padding=1, bias=False)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    model.fc = nn.Linear(512, DefaultConfig.num_classes)
    return model
