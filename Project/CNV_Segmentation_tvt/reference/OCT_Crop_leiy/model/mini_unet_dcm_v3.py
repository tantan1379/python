...
class Mini_Unet_Dcm_V3(nn.Module):
    def __init__(self, in_channels=3, n_classes=3, feature_scale=1, is_deconv=False, is_batchnorm=True):
        super(Mini_Unet_Dcm_V3, self).__init__()
