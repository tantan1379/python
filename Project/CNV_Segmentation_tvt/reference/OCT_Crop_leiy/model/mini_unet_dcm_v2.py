...
class Mini_Unet_Dcm_V2(nn.Module):
    def __init__(self, in_channels=1, n_classes=3, feature_scale=2, is_deconv=False, is_batchnorm=True):
        super(Mini_Unet_Dcm_V2, self).__init__()
...
if __name__ == '__main__':
    model = Mini_Unet_Dcm_V2()
    torchsummary.summary(model, (1, 512, 448),device='cpu')