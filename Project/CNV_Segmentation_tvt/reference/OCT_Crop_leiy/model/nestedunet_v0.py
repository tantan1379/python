...
class NestedUNet_V0(nn.Module):
    def __init__(self, input_channels,deepsupervision):
        super().__init__()
...
if __name__ == '__main__':
    ...
    model = NestedUNet_V0(input_channels=3,deepsupervision=False)
    torchsummary.summary(model, (3, 512, 448),device='cpu')
    # torchsummary.summary(model.cuda(), (3, 512, 448))