...
class SegOCT(Dataset):
    def __init__(self, base_path, scale = (256, 432), mode='train',label_number = "label_1", k_fold_test = 1):
        super().__init__()
        self.mode = mode
...
if __name__ == '__main__':
    path = '/home/leiy/DLProjects/Graduation_Design/OCT/data'
    segOCT_dataset = SegOCT(path, mode='train_eval')
    ...
    for i,(data,label) in enumerate(dataloader_test):
        print(data)
        print(label)
    # image = cv2.imread('/home/leiy/DLProjects/Graduation_Design/OCT/data/data_image/f1/19645_cube/19645_0.png')
    # print(image.shape)
