...
from data_roi import SegOCT





from model.mini_unet_dcm_for_roi_v0 import Mini_Unet_Dcm_For_Roi_V0
...
def main(mode='train', args=None, writer=None, k_fold=1, device = None, local_rank = None):
    ...
    model_all = {
                 ...
                 'Mini_Unet_Dcm_For_Roi_V0': Mini_Unet_Dcm_For_Roi_V0(in_channels=args.input_channel, n_classes=args.num_classes),
