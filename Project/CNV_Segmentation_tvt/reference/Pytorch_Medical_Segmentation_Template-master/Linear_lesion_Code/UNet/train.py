...
def main(mode='train', args=None, writer=None, k_fold=1):
    ...
    dataset_train = LinearLesion(dataset_path, scale=(args.crop_height, args.crop_width), k_fold_test=k_fold,
                                 mode='train')
    ...
    dataset_test = LinearLesion(dataset_path, scale=(args.crop_height, args.crop_width), k_fold_test=k_fold,
                                mode='test')
