...
class R2U_Net(nn.Module):
    def __init__(self, in_channels=1,n_classes=4, feature_scale=4, t=2):
        ...
        self.RRCNN1 = RRCNN_block(ch_in=in_channels, ch_out=filters[0], t=t)
...
class RRCNN_block(nn.Module):
    def __init__(self,ch_in,ch_out,t=2):
        ...
        self.Conv_1=nn.Conv2d(ch_in,ch_out,kernel_size=1,stride=1,padding=0)
        # initialise the blocks
        for m in self.children():
            init_weights(m, init_type='kaiming')
...
if __name__ == '__main__':
    ...
    model = R2U_Net(in_channels=3, n_classes=1).cuda()
