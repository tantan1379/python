...
def net_builder(name,pretrained=False,n_classes=3):
    # if name == 'resnet50_unet':
    #     net = resnet50_UNet(pretrained=pretrained)
    if name == 'unet':
        net = UNet(in_channels=1, n_classes=n_classes, feature_scale=2)
    # elif name == 'unet_pp_raw':
    #     net = UNet_PP(in_channels=3, n_classes=n_classes)
    # elif name == 'ISBI_Backbone':
    #     net = ISBI_Backbone(in_channels=3, n_classes=n_classes)
    # elif name == 'resunet_pp*0.5-1':
    #     net = ResUNet_PP(n_classes=n_classes)
    # elif name == 'resunet_pp-1':
    #     net = ResUNet_PP(n_classes=n_classes)
    # elif name == 'resunet_pp_0':
    #     net = ResUNet_PP(n_classes=n_classes)
    # elif name == 'Dynamic_SPP_UNet':
    #     net = Dynamic_SPP_UNet(in_channels=3,n_classes=n_classes)
    # elif name == 'Dynamic_SPP_Caps_UNet':
    #     net = Dynamic_SPP_Caps_UNet(in_channels=3,n_classes=n_classes)
    # elif name == 'Caps_ResUNet':
    #     net = Caps_ResUNet(in_channels=3,n_classes=n_classes)
    # elif name == 'Caps_ResUNet_V1':
    #     net = Caps_ResUNet_V1(in_channels=3,n_classes=n_classes)
    # elif name == 'cpfnet':
    #     net = CPFNet(in_channels=3, out_planes=n_classes)
    # elif name == 'CEnet':
    #     net = CE_Net(in_channels=3, n_classes=n_classes)
    # elif name == 'R2U_Net':
    #     net= R2U_Net(in_channels = 3,n_classeses=n_classes,feature_scale=2)
    # elif name == 'AttU_Net':
    #     net = AttU_Net(in_channels=3, n_classes=n_classes, feature_scale=2)
    # elif name == "PSPNet":
    #     net = PSPNet(n_classes=n_classes)
    # elif name == "Deeplab":
    #     net = DeepLab(n_classes=1)
    # elif name == "UNet_MGPA":
    #     net = UNet_MGPA(in_channels=3, n_classeses=n_classes, feature_scale=2)
    # elif name == "UNet_MAD":
    #     net = UNet_MAD(in_channels=3, n_classeses=n_classes, feature_scale=2)
    # elif name == "UNet_MGPA_MAD":
    #     net = UNet_MGPA_MAD(in_channels=3, n_classeses=n_classes, feature_scale=2)
    # elif name == "MAD_Mf2_1":
    #     net = MAD_Mf_1(n_classes=n_classes)
    # elif name == "MAD_Mf2_2":
    #     net = MAD_Mf_1(n_classes=n_classes)
    # elif name == "MAD_Mf2_3":
    #     net = MAD_Mf_1(n_classes=n_classes)
    ...
    #     net = MAD_ONLY_MAD(n_classes=n_classes)
    ...
    #     net = MAD_ONLY_SPP(n_classes=n_classes)
    ...
    #     net = Resunet(in_channels=3, out_planes=n_classes)
    # elif name == 'resunet_row':
    #     net = Resunet_row(in_channels=3, out_planes=n_classes)
    # elif name == "SPPResUNet":
    #     net = SPPResUNet(n_classes=n_classes)
